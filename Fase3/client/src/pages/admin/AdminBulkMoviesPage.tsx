                    ...
                    {result.errors.map((rowError) => (
                      ...
                      >
                        ...
                        <div className="mt-4">
                          ...
                          <pre className="text-xs bg-muted/10 text-foreground p-3 rounded border overflow-auto">
      ...
      <div className="border rounded-lg p-6 bg-card space-y-4">
        ...
        <div className="text-sm text-muted-foreground space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>Primera fila = cabecera</li>
            <li>géneros separados por <code>|</code></li>
            <li>tipo: ESTRENO, PREVENTA, REESTRENO</li>
