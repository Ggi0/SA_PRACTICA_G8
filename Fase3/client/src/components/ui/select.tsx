...
function SelectTrigger({ className, children, ...props }: React.HTMLAttributes<HTMLButtonElement> & { disabled?: boolean }) {
  return (
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        {...(props as React.ComponentProps<typeof SelectPrimitive.Content>)}
      >
...
function SelectItem({ className, children, ...props }: React.HTMLAttributes<HTMLDivElement> & { value: string; disabled?: boolean }) {
  return (
